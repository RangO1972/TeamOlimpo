"""Entry point CLI per kba.meeting.

Uso:
    python -m tools.kba.meeting "Owner's Inbox/KBA_Merged_xxx.xlsx"
...
from tools.kba.reporter.brief_builder import build_wip_brief, _kba_to_slug, _read_catalog_meta
from tools.kba.reporter.config import (
    WIP_KEYWORDS,
    OWNERS_INBOX_DIR,
    PROJECT_ROOT,
)
from tools.llm.config import get_api_key, PROMPTS_DIR
