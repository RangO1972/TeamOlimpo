...
def main(
    ...
    if mancanti:
        ...
        console.print("  1. Copia i PDF mancanti in:  Team/Inbox/")
        console.print("  2. Converti:  python -m tools.pdf_converter convert-all")
        console.print("  3. Analizza:  python -m tools.consulto --prompt Library/Prompts/kba/analisi-rischio-kba.md \\")
        console.print("                  --input Library/documents/<slug>.md \\")
        console.print("                  --output Team/Handoff/kba_batch/ --provider grok")
        console.print("  4. Indicizza: python -m tools.kba_indexer index --input Team/Handoff/kba_batch/")
