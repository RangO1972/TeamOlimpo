"""
Entry point CLI per il tool kba.merger.
...
def merge(
    ...
    from tools.kba.merger.enricher import enrich_rows
    from tools.kba.merger.merger import merge_rows
    from tools.kba.merger.writer import write_merge_excel
...
def learn(
    ...
    from tools.kba.merger.learner import run_learn
...
def gap(
    ...
    from tools.kba.merger.writer import write_gap_excel, write_gap_txt
