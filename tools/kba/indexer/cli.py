"""
Entry point CLI per il tool kba.indexer.
...
Utilizzo:
  python -m tools.kba.indexer <comando> [opzioni]
"""
...
from tools.kba.indexer.config import (
    BATCH_DIR,
    INDEX_FILE,
    LOG_FILE,
    PROJECT_ROOT,
...
from tools.kba.indexer.parser import parse_batch_file
from tools.kba.indexer.writer import rebuild_index, write_record
