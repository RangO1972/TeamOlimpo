---
title: "Analisi e Stima Tempi KBA - Input Metis"
tags: [analisi, tempi, kba, metis]
aliases: [Analisi Metis Stima Tempi KBA]
cssclasses: [analisi]
last_updated: 2026-05-05
---

# Analisi e Stima Tempi per Patching/Installazione KBA
...
- Non scalato per numero nodi individuali (applicazione batch automatica).
- Logistica: +0.5h per sito remoto (Montecchio, Lonigo); Termoli centrale (0).
- Totale KBA: somma tempi per siti in cui presente.
...
## Verifica Logica e Osservazioni
...
- Colli di bottiglia: Montecchio più oneroso.
- Ottimizzazioni: sequenzializzazione per sito/tipo, raggruppamento visite remote.

## Domanda Aperta
Stima per KBA per sito o scalare per numero nodi?