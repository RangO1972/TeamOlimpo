...
|------|-------|--------|--------|-----------|
| 1 | User | Request new agent to Hermes | — | — |
| 2 | Hermes | Clarify: domain, boundaries, team gaps | — | ✅ User approves direction |
...
| 5 | Hermes | Route research handoff + review handoff to user for discussion | — | ✅ User approves research |
...
| 8 | Hermes | Present final design to user | — | ✅ User approves design |
...
| 10 | Hermes | Activate agent, update Scratchpad | — | — |
...
**Every handoff IS the brief for the next actor.** Hermes does not write a new brief — he passes the previous handoff's file path to the next agent.
