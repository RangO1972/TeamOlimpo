...
4. **Archiviazione periodica.** I task completati vanno spostati in `Tasks/completed/` o in `Team/Handoff/Archivio/` se sono handoff verso altri membri.
5. **No duplicazione con Handoff.** Se un file deve essere letto da un altro membro, va in `Team/Handoff/`, non in `Team/<Agente>/Notes/`.
...
- Output completi di task (vanno in `Team/Handoff/` o `Library/deliverables/`).
...
active_tasks:
  - id: "T-001"
    ...
    handoff_ref: "Team/Handoff/kba_batch/"  # path ai file di riferimento
    notes: ""
```
...
active_tasks:
  - id: "T-001"
    ...
    started_at: 2026-05-04
    due_at: null
    handoff_ref: "Team/Handoff/kba_batch/"
    notes: ""
...
| ID | Titolo | Delegato a | Stato | Note |
|----|--------|------------|-------|------|
| T-001 | Analisi batch 15 KBA | Dike | in_progress | Input: Team/Handoff/kba_batch/ |
```
...
**Regola**: se un file deve essere letto da un altro membro, va in `Team/Handoff/`. Lo scratchpad contiene solo il **riferimento** (path), non il contenuto.
...
### Relazione con `Team/Handoff/brief-*`
...
active_tasks:
  - id: "T-002"
    ...
    status: "in_progress"
    started_at: 2026-05-04
    handoff_ref: "Team/Handoff/brief-wip-020426.md"
    notes: ""
```
...
active_tasks:
  - id: "T-003"
    ...
    delegated_to: "Atena"
    status: "in_progress"
    handoff_ref: "Team/Fucina/analyses/proteo.md"
