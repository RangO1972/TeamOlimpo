...
- [ ] `.gitignore` non contiene `Team/Hermes/` (rimosso — ora tracciato)
...
Rimuovere la riga `Team/Hermes/` (ora deve essere tracciato). Aggiungere:

```gitignore
Team/Fucina/
```

**Attenzione**: `Team/Handoff/` e `Team/Hermes/` NON vanno in .gitignore.
